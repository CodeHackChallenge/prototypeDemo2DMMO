...
public class EntityFactory { 
	...
	public static Entity createPlayer(float x, float y) {
	    ...
	    // Base stats 
	    Stats stats = new Stats(1000, 50, 2, 0, 50);
 ...
 // Add this method to EntityFactory.java
    ...
    public static Entity createFionne(float x, float y) {
        ...
        Quest collectItemsForCrafting = new Quest(
            //"goblin_slayer",
            //"Goblin Slayer",
            "collect_recipes",
            "Collect recipes",
        ...
        // Set rewards
        collectItemsForCrafting.setExpReward(150);
        collectItemsForCrafting.setAurelReward(50);
        collectItemsForCrafting.addItemReward("Potion of Minor Healing");
        ...
        // Add quest to NPC
        npcComponent.addQuest(collectItemsForCrafting);
     ...
     */
    public static Entity createPortal(String id, float worldX, float worldY, 
                                       String targetMap, int targetX, int targetY) {
        Entity portal = new Entity("Portal_" + id, EntityType.PORTAL);
        
        portal.addComponent(new Position(worldX, worldY));
        portal.addComponent(new Portal(id, targetMap, targetX, targetY));
        
        // Collision box for detection
        portal.addComponent(new CollisionBox(-24, -24, 48, 48));
        
        // Rendering
        portal.addComponent(new Renderable(RenderLayer.GROUND_DECOR));
