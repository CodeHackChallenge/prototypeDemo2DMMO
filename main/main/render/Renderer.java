...
public class Renderer {
 ...
 // ★★★ OPTIMIZED: BATCHED RENDERING BY FONT TYPE ★★★
    private void renderWorldUI(Graphics2D g, float cameraX, float cameraY) {
     ...
     // ========================================
     // BATCH: QUEST INDICATORS (★ BYPASS RENDER OBJECTS)
     // ========================================
     g.setFont(QUEST_INDICATOR_FONT);

     // ★ CRITICAL: Don't use sortedRenderObjects - go directly to entities
     for (Entity entity : gameState.getEntities()) {
         ...
         // ★ Get component fresh from entity EVERY frame
         ...
         // ★ Read type field DIRECTLY - no method calls
         String symbol;
         Color color;
         ...
         if (qi.type == QuestIndicator.IndicatorType.IN_PROGRESS) {
            ...
            // System.out.println("[Renderer] Drawing IN_PROGRESS indicator"); // DEBUG
         } else if (qi.type == QuestIndicator.IndicatorType.COMPLETE) {
             symbol = "?";
             color = new Color(255, 215, 0);
             //System.out.println("[Renderer] Drawing COMPLETE indicator"); // DEBUG
         } else { // AVAILABLE or default
             symbol = "!";
             color = new Color(255, 215, 0);
             //System.out.println("[Renderer] Drawing AVAILABLE indicator"); // DEBUG
         }
